...
DATABASES = {
    ...
    "bod": {
        ...
        "OPTIONS": {"options": "-c search_path=public,re3"},
    },
}
...
COGNITO_MANAGED_FLAG_NAME = env.str(
...
LOGGING_MAX_REQUEST_PAYLOAD_SIZE = env.int(
    "LOGGING_MAX_REQUEST_PAYLOAD_SIZE", default=200
)
...
_DEFAULT_LOG_ALLOWED_HEADERS = [
    ...
    "x-e2e-testing",
    # API GW Headers
    "geoadmin-authenticatedgeoadmin-username",
    "apigw-requestid",
]
LOG_ALLOWED_HEADERS = [
    str(header).lower()
