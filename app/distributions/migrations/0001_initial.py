    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_it', models.CharField(blank=True, verbose_name='Description (Italian)')),
                ('description_rm', models.CharField(blank=True, verbose_name='Description (Romansh)')),
